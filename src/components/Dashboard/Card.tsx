...
function Card({ amount, text, trend }: {
    ...
    return (
        <div className={`w-full h-full  rounded-xl  px-0  bg-white  flex flex-col gap-0 relative justify-between`}
            key={text}
        >
            <h1 className={`text-4xl font-medium  font-sans h-full w-full tracking-tight text-black  px-7 py-8 `}>
                {amount}
            </h1>
            <div className="flex items-center w-full justify-between px-7 py-3 bg-neutral-50 h-full rounded-lg">
